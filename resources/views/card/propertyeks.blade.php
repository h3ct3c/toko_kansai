...
<div class="product-card bg-white rounded-2xl shadow-md hover:shadow-xl transition-all overflow-hidden group" data-category="eksterior">
  ...
  <div class="relative w-full h-64 bg-gray-100 flex items-center justify-center overflow-hidden">
    <a href="propertyeks">
    <img src="img/propertyeks.png" 
         alt="KANSAI PROPERTY EKSTERIOR"
  ...
  <div class="p-5">
    ...
    <p class="text-gray-500 text-sm mt-1">
      Cat eksterior KANSAI PROPERTY EKSTERIOR tersedia dalam berbagai warna menarik dengan hasil akhir yang indah.
    </p>

    <!-- Harga -->
    <div class="mt-3">
      <span class="text-xl font-bold text-gray-900">Rp 225.000</span>
    </div>
