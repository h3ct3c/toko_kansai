<!-- Card Produk -->
<body>
<div class="product-card bg-white rounded-2xl shadow-md hover:shadow-xl transition-all overflow-hidden group" data-category="eksterior">
    <a href="rainblock">
  
  <!-- Gambar Produk -->
  <div class="relative w-full h-64 bg-gray-100 flex items-center justify-center overflow-hidden">
    <a href="rainblock">
    <img src="img/rainblock.png" 
         alt="KANSAI RAIN BLOCK"
         class="h-[200px] w-auto padding-auto mb-50px object-contain group-hover:scale-105 transition-transform duration-300">
    
    <!-- Badge Kategori -->
    <span class="absolute top-2 left-2 bg-teal-500 text-white text-xs font-semibold px-3 py-1 rounded-full shadow">
      Eksterior
    </span>
  ...
  <div class="p-5">
    ...
    <p class="text-gray-500 text-sm mt-1">
      Cat eksterior KANSAI RAIN BLOCK menjaga rumah Anda dari kebocoran dan rembesan air untuk jangka waktu yang lama.
    </p>

    <!-- Harga -->
    <div class="mt-3">
      <span class="text-xl font-bold text-gray-900">Rp 240.000</span>
    </div>
...
<script>
  // ambil jumlah awal dari localStorage biar nggak hilang kalau reload
