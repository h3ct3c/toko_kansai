...
<div class="product-card bg-white rounded-2xl shadow-md hover:shadow-xl transition-all overflow-hidden group" data-category="interior">
  ...
  <div class="relative w-full h-64 bg-gray-100 flex items-center justify-center overflow-hidden">
    <a href="propertyint">
    <img src="img/propertyint.png" 
         alt="KANSAI PROPERTY INTERIOR"
  ...
  <div class="p-5">
    ...
    <p class="text-gray-500 text-sm mt-1">
      Cat interior KANSAI PROPERTY INTERIOR dengan formula khusus untuk membasmi kuman & bakteri pada tembok Anda. 
    </p>

    <!-- Harga -->
    <div class="mt-3">
      <span class="text-xl font-bold text-gray-900">Rp 145.000</span>
    </div>
