...
<div class="product-card bg-white rounded-2xl shadow-md hover:shadow-xl transition-all overflow-hidden group" data-category="premium">
  ...
  <div class="p-5">
    ...
    <p class="text-gray-500 text-sm mt-1">
     Cat multifungsi KANSAI SPLESH GLIMMER memiliki kilap memukau serta mudah dibersihkan sehingga cocok untuk berbagai kebutuhan Anda.
    </p>
  ...
  <a href="javascript:void(0)"
    ...
    <!-- Toast Notification -->
<div id="toast" class="fixed top-16 right-5 hidden z-50">
