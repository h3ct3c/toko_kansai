...
<div class="product-card bg-white rounded-2xl shadow-md hover:shadow-xl transition-all overflow-hidden group" data-category="kayubesi">
  ...
  <div class="p-5">
    ...
    <p class="text-gray-500 text-sm mt-1">
      Cat kayu & besi KANSAI FTALIT cocok untuk pengecatan kayu, logam, dan berbagai konstruksi besi.Sesuaikan dengan kebutuhan Anda.
    </p>

    <!-- Harga -->
    <div class="mt-3">
      <span class="text-xl font-bold text-gray-900">Rp 95.000</span>
    </div>
<!-- Tombol -->
    <div class="mt-4">
