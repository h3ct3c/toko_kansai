...
@section('content')
<div class="bg-white shadow-xl rounded-2xl p-6 space-y-8">

    {{-- GRID CARD STATISTICS --}}
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">

        {{-- Total Revenue --}}
        <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300 flex items-center justify-between">
            <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="col-span-2 bg-white p-6 rounded-xl shadow-sm">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm text-gray-500">Tren Pendapatan Bulanan</span>
            </div>
