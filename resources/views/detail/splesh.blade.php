  ...
  <div class="container mx-auto px-4 py-8">
    <div class="flex flex-wrap -mx-4">
      ...
      <div class="w-full md:w-1/2 px-4">
        <!-- Title -->
        <h2 class="text-3xl font-bold mb-2">KANSAI SPLESH</h2>
        ...
        <p class="text-gray-700 mb-6">
          KANSAI SPLESH adalah cat warna interior berbasi air yang dirancang khusus untuk memberikan hasil akhir yang halus dan tahan lama pada dinding dan permukaaan , Segera beli KANSAI SPLESH sekarang juga.
        </p>
