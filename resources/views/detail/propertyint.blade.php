    ...
    <div class="flex flex-wrap -mx-4">
      ...
      <div class="w-full md:w-1/2 px-4">
        ...
        <p class="text-gray-700 mb-6">
          KANSAI PROPERTY INTERIOR adalah cat warna interior berbasis air yang diformulasikan khusu untuk memberikan hasil akhir yang halus dan tahan lama pada dinding dan permukaan dalam ruangan. Dengan teknologi canggih, cat ini menawarkan daya tutup yang sangat baik serta ketahanan terhadap noda dan goresan 
        </p>
