  ...
  <div class="container mx-auto px-4 py-8">
    <div class="flex flex-wrap -mx-4">
      ...
      <div class="w-full md:w-1/2 px-4">
        <!-- Title -->
        <h2 class="text-3xl font-bold mb-2">Kansai FTALIT</h2>
        ...
        <p class="text-gray-700 mb-6">
          KANSAI FTALIT adalah cat warna kayu dan besi berkualitas tinggi yang memberikan perlindungan optimal serta hasl akhir yang indah
        </p>
