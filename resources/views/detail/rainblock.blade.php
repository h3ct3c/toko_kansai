  ...
  <div class="container mx-auto px-4 py-8">
    <div class="flex flex-wrap -mx-4">
      ...
      <div class="w-full md:w-1/2 px-4">
        <!-- Title -->
        <h2 class="text-3xl font-bold mb-2">KANSAI RAIN BLOCK</h2>
        ...
        <p class="text-gray-700 mb-6">
          KANSAI RAIN BLOCK adalah cat warna eksterior berkualitas tinggi yang dirancang khusus untuk melindungi dan memperindah permukaan luar bangunan. Dengan formula tahan cuaca dan sinar UV, cat ini memberikan perlindungan jangka panjang terhadap elemen alama seperti hujan, panas, dan polusi, serta menjaga keindahan, BURUAN BELI KANSAI RAIN BLOCK SEKARANG JUGA! 
        </p>
