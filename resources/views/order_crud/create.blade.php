...
<div class="container mx-auto mt-10 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow-2xl rounded-2xl p-8 lg:p-10 max-w-5xl mx-auto border-t-4 border-blue-900 ring-1 ring-gray-100">
        ...
        <div class="flex items-center mb-10 pb-4 border-b border-gray-200">
            ...
            <h2 class="text-3xl font-bold text-blue-900 tracking-tight">Buat Order Baru</h2>
        </div>
        ...
        <form action="{{ route('orderCrud.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <select id="customer_id" name="customer_id"
                        class="w-full border border-gray-300 rounded-xl pl-4 pr-4 py-3 bg-gray-50 focus:bg-white 
                        focus:ring-2 focus:ring-blue-800 focus:border-blue-800 transition text-gray-800">
            ...
            {{-- Row 3: Alamat dan Nomor Telepon --}}
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <label for="jalan" class="block text-gray-700 font-semibold mb-2">Jalan</label>
