...
<body>
  <!-- Sidebar -->
  <aside class="w-[356px] bg-gradient-to-br from-gray-400 to-gray-500
             text-white min-h-[680px] flex flex-col">
    ...
    <nav class="flex-1 space-y-2">
      ...
      <a href="{{ route('profile.show') }}" 
         class="py-12 px-12 hover:text-gray-300 rounded-lg flex items-center gap-8">
        ...
        <span class="text-lg font-medium">Account Overview</span>
      </a>
      ...
      <a href="{{ route('profile.edit') }}" 
        ...
        <span class="text-lg font-medium">Account Settings</span>
      </a>
    </nav>
  </aside>
