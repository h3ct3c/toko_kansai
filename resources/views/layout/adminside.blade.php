...
<aside class="w-64 bg-blue-900 text-white min-h-screen flex flex-col">
  ...
  <nav class="flex-1 space-y-2">
    <!-- Dashboard -->
    <a href="" class="nav-link block py-3 px-6 hover:text-blue-600 rounded-lg flex items-center gap-3">
    ...
    <!-- Product -->
    <a href="/product_crud" class="nav-link block py-3 px-6 hover:text-blue-600 rounded-lg flex items-center gap-3">
