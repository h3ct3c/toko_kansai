...
<body class="bg-white font-sans text-gray-700">
  ...
  <!-- Topbar -->
  <div class="bg-gray-100 text-gray-600 text-xs font-semibold">
    <div class="max-w-7xl mx-auto flex justify-end py-2">
      <div class="flex space-x-5">
        <a href="/find-a-store" class="hover:text-blue-700 pr-2 border-r border-gray-400">Find a Store</a>
        <a href="/help" class="hover:text-blue-700 pr-2 border-r border-gray-400">Help</a>
        <a href="/join-us" class="hover:text-blue-700 pr-2 border-r border-gray-400">Join Us</a>
  ...
  <!-- Navbar -->
  <nav class="w-full flex flex-wrap items-center justify-between px-6 py-2 shadow-sm top-0 bg-white z-50">

    <!-- Logo -->
    <a href="/" class="flex items-center space-x-2 px-8">
      <img src="/img/logo.png" class="h-12" alt="Kansai Paint Logo">
    </a>

    <!-- Menu -->
    <ul class="flex flex-wrap items-center gap-x-3 gap-y-1 text-sm font-medium text-gray-700 mt-3 md:mt-0">
      <li>
      ...
      <li class="relative group">
        ...
        <!-- Dropdown Product -->
        <div class="fixed left-0 hidden group-hover:flex bg-white shadow-lg rounded-lg w-full p-8">
          <div class="grid grid-cols-4 gap-6 w-full max-w-3xl mx-auto">
    ...
    <div class="flex flex-wrap items-center gap-4 mt-3 md:mt-0">
      ...
      <!-- Search -->
      <form action="{{ route('search') }}" method="GET" class="relative w-48 md:w-[240px]">
        <input
          type="text"
          name="query"
